...
def prompt_recover_snapshot(
    ...
    recovered_btn = msg.addButton(
        "Recovered", QtWidgets.QMessageBox.ButtonRole.AcceptRole
    )
    original_btn = msg.addButton(
        "Original", QtWidgets.QMessageBox.ButtonRole.DestructiveRole
    )
