...
def bulk_update_paren_profile(
    df: pd.DataFrame, old_paren: str, new_paren: str
) -> pd.DataFrame:
...
def bulk_update_speed_feed(
    df: pd.DataFrame, profilename: str, new_level: int
) -> pd.DataFrame:
...
def bulk_update_speed_feed_all_matching_paren(
    df: pd.DataFrame, paren: str, new_level: int
) -> pd.DataFrame:
...
def bulk_update_speed_overall_all_matching_paren(
    df: pd.DataFrame, paren: str, new_level: int
) -> pd.DataFrame:
